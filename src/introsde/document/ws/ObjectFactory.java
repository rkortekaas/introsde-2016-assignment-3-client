...
public class ObjectFactory {
    ...
    private final static QName _ParseException_QNAME = new QName("http://ws.document.introsde/", "ParseException");
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.document.introsde/", name = "ParseException")
